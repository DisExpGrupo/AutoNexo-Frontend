  ...
  <div class="an-dashboard">
    ...
    <template v-if="loading">
      <div class="detail-loading">
        <p class="detail-loading-text">Loading vehicles...</p>
      </div>
    </template>
      ...
      <div class="vehicle-empty-state">
        <div class="vehicle-empty-icon">
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
            <path d="M8 26V17L12 13H28L32 17V26H8Z" stroke="#1B7A5A" stroke-width="2" stroke-linejoin="round"/>
            <circle cx="13" cy="26" r="2" fill="#1B7A5A"/>
            <circle cx="27" cy="26" r="2" fill="#1B7A5A"/>
            <path d="M15 13H25" stroke="#1B7A5A" stroke-width="2"/>
          </svg>
        </div>
